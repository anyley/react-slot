...
export const HeadersPage = () => {
  ...
  return (
    <div>
      ...
      <Breadcrambs.Portal order={2}>Closed headers</Breadcrambs.Portal>
...
const ComponentWithHeader = ({ header }) => (
  <div>
    <Breadcrambs.Portal order={2}>Opened headers</Breadcrambs.Portal>

    <Header.Portal>Header 1</Header.Portal>

    <h2>1. Start editing to see some magic happen!</h2>

    <Header.Portal order={2} render={() => <div>Header 2</div>} />

    <h2>2. Start editing to see some magic happen!</h2>

    <Header.Portal order={3}>
      {props => <div>Header {props.value}</div>}
    </Header.Portal>
  </div>
)
